    ...
    <footer className="footer p-10 bg-neutral text-neutral-content  ">
      ...
      <div>
        ...
        <h2 className="hover:text-white">
          <a href="https://goo.gl/maps/kxCzZfgsedbDUKJP6">
            {" "}
        ...
        <h2>6:00pm - 8:00pm </h2>
        <h2 className="hover:text-white">
          <a href="tel:816-920-1448"> (816) 797-8885</a>
        </h2>
      </div>
      <div>
        <span className="footer-title">Pages</span>
        <NavLink to="/" className="link link-hover">Home</NavLink>
        <NavLink to="/join" className="navbar-join link link-hover">Join</NavLink>
        <NavLink to="/boxers" className="navbar-boxers link link-hover">Boxers</NavLink>
        <NavLink to="/coaches" className="navbar-coaches link link-hover">Coaches</NavLink>
        <NavLink to="/events" className="navbar-events link link-hover">Events</NavLink>
        <NavLink to="/about" className="navbar-about link link-hover">About</NavLink>
